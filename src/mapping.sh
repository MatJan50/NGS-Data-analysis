...
for (( i = 5; i <= 7; i++ ))
	...
	bwa sampe saccharomyces_reference_genome.fna.gz "../mapping/SRR06454${i}.sai" "../quality_control/SRR06454${i}_1.fastp.fastq.gz" "../quality_control/SRR06454${i}_2.fastp.fastq.gz" | \
